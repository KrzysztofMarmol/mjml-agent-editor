...
import { useDocumentStore } from "../../index.js";
import type { EditorApi, EditorState, SaveStatus } from "../editor/EmailEditor.js";
...
export default function EditorHeader({
  ...
  openCount: number;
  /**
   * Rendered in the overflow menu as the way back out of the editor. Routing belongs to
   * the host — a Next.js app passes `<Link href="/">`, anything else passes an anchor —
  ...
  const openCode = () =>
    setCode({ mjml: api?.getMjml() ?? "", html: api?.getCompiledHtml() ?? "" });
